/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 04cc85aca1db2fe7056c9d85c0689359)
// Runtime types generated with workerd@1.20250730.0 2025-08-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		EMAIL_LIST_KV: KVNamespace;
		FORM_SUBMISSIONS_KV: KVNamespace;
		PUBLIC_TURNSTILE_SITE_KEY: string;
		TURNSTILE_SECRET_KEY: string;
		RESEND_API_KEY: string;
		EMAIL_LIST_RECIPIENTS: string;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_TURNSTILE_SITE_KEY" | "TURNSTILE_SECRET_KEY" | "RESEND_API_KEY" | "EMAIL_LIST_RECIPIENTS">> {}
}
